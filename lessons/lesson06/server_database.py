...
if __name__ == '__main__':
    test_db = ServerStorage('my_testing_codes/old_files/db_lesson5/server_database.db3')
    # выполняем 'подключение' пользователя
    # test_db.user_login('client_1', '192.168.1.4', 8888)
    # test_db.user_login('client_2', '192.168.1.5', 7777)
    test_db.user_login('test_user_1', '192.168.1.113', 8080)
    test_db.user_login('test_user_2', '192.168.1.113', 8081)
