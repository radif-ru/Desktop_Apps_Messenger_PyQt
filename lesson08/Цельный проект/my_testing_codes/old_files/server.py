...
from common.variables import ACTION, ACCOUNT_NAME, PRESENCE, TIME, USER, ERROR, \
    MESSAGE, MESSAGE_TEXT, SENDER, \
    RESPONSE_200, RESPONSE_400, EXIT, \
    DESTINATION, GET_CONTACTS, RESPONSE_202, LIST_INFO, ADD_CONTACT, \
    REMOVE_CONTACT, USERS_REQUEST, DEFAULT_PORT, SERVER_SETTINGS_PATH
